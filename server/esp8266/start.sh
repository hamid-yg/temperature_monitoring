...
node aws-iot-device-sdk-js-v2/samples/node/pub_sub/dist/index.js --endpoint apnje8usx8np-ats.iot.us-west-2.amazonaws.com --key esp8266.private.key --cert esp8266.cert.pem --ca_file root-CA.crt --client_id sdk-nodejs-v2 --topic sdk/test/js